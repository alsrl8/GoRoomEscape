...
func main() {
	...
	startPosition := structure.Position{Row: 5, Col: 1}
	...
	startRoom := initialize.InitGameAndReturnStartPoint(rowLen, colLen, &roomPositions, &doorPositionAndType, startPosition, endPosition, endDirection, &itemPositionAndType)
	gameStart(startRoom)
}
